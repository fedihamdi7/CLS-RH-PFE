...
exports.addContract = (req, res) => {
  ...
  newContract.date_signature = moment(req.body.date_signature).format(
    "YYYY-MM-DD[T00:00:00.000Z]"
  );
  newContract.expires_at = moment(req.body.expires_at).format(
    "YYYY-MM-DD[T00:00:00.000Z]"
  );
  ...
  switch (req.body.payment_status) {
    case "paid":
      newContract.payment_status = req.body.payment_status;
      newContract.contract_details.payment_date = moment(
    ...
    case "not_paid":
      // newContract.contract_details.method = req.body.method;
      newContract.contract_details.payment_amount = req.body.payment_amount;
      newContract.contract_details.due_date = moment(req.body.due_date).format(
        "YYYY-MM-DD[T00:00:00.000Z]"
      );
      break;
    case "paid_by_split":
